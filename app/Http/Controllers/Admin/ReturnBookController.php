...
class ReturnBookController extends Controller
{
    public function index(): Response
    {
        ...
        ->select(['id', 'return_book_code', 'status', 'loan_id', 'book_id', 'user_id', 'return_date', 'created_at',])
    ...
    public function create(Loan $loan): Response | RedirectResponse
    {
        ...
        return inertia('Admin/ReturnBooks/Create', [
            'page_settings' => [
                ...
                'subtitle' => 'Kembalikan buku yang dipinjama disini. Klik kembalikan setelah selesai.',
                'method' => 'POST',
