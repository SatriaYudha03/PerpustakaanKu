                    ...
                    <Table className="w-full">
                        ...
                        <TableBody>
                            {users.map((user, index) => {
                                // Menambahkan log untuk memeriksa nilai user.cover
                                // console.log(user.cover);  // Memeriksa URL gambar
                                ...
                                return (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>
                                            <Avatar>
                                                <AvatarImage src={user.cover}></AvatarImage>
                                                ...
                                                <AlertDialog>
                                                    ...
                                                    <AlertDialogContent>
                                                        <AlertDialogHeader>
                                                            ...
                                                            <AlertDialogDescription>
                                                                Tidakan ini tidak dapat dibatalkan. Tindakan ini akan
